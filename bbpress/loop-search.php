...
/**
 * Template override : Boucle de résultats de recherche
 *
 * Boucle parente qui délègue l'affichage de chaque résultat
 * au template `loop-search-{post_type}.php` approprié.
 *
 * @package SwiftBoard
 */
...
<ul id="bbp-search-results" class="forums bbp-search-results">
    ...
    <li class="bbp-header">
        ...
        <div class="bbp-search-author"><?php esc_html_e('Auteur', 'swiftboard'); ?></div><!-- .bbp-reply-author -->
    ...
    <li class="bbp-footer">
        ...
        <div class="bbp-search-author"><?php esc_html_e('Auteur', 'swiftboard'); ?></div>
