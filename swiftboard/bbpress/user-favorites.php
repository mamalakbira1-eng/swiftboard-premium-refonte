...
/**
 * Template override : Favoris utilisateur
 *
 * Liste des sujets favoris de l'utilisateur courant.
 *
 * @package SwiftBoard
 */
...
<div id="bbp-user-favorites" class="bbp-user-favorites">
    ...
    <h2 class="entry-title"><?php esc_html_e('Sujets favoris', 'swiftboard'); ?></h2>
