...
/**
 * Template override : Abonnements utilisateur
 *
 * Deux blocs : forums suivis + sujets suivis.
 *
 * @package SwiftBoard
 */
...
<?php if (bbp_is_subscriptions_active()) : ?>
    ...
    <?php if (bbp_is_user_home() || current_user_can('edit_user', bbp_get_displayed_user_id())) : ?>
        ...
        <div id="bbp-user-subscriptions" class="bbp-user-subscriptions">
            ...
            <h2 class="entry-title"><?php esc_html_e('Forums suivis', 'swiftboard'); ?></h2>
            ...
            <h2 class="entry-title"><?php esc_html_e('Sujets suivis', 'swiftboard'); ?></h2>
            <div class="bbp-user-section">
