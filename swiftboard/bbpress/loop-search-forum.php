...
/**
 * Template override : Résultat de recherche — Forum
 *
 * @package SwiftBoard
 */
?>
...
<div class="bbp-forum-header">
    <div class="bbp-meta">
        <span class="bbp-forum-post-date"><?php printf(esc_html__('Dernière activité %s', 'swiftboard'), bbp_get_forum_last_active_time()); ?></span>
    ...
    <div class="bbp-forum-title">
        ...
        <h3><?php esc_html_e('Forum :', 'swiftboard'); ?>
